<div class="desktop">
    <div id="warousel" class="carousel slide carousel-dark slide d-flex justify-content-center align-items-center" data-bs-ride="carousel">
                ...
                <div class="row warousel-row m-auto">
                    <div class="col d-flex flex-column justify-content-center align-items-center" class="wtext">
                        ...
                        <div class="wkontak">
                            ...
                            <a href="https://wa.me/6283837908426" class="wlink"><img src="{{asset('assets/profil-desa/img/wisata/wcontact.png')}}" alt="" class="wimg">083837908426</a>
                        </div>
                    </div>
                    <div class="col d-flex justify-content-center align-items-center">
    
                        <img class="wisata-img" src="../assets/profil-desa/img/wisata/loo.png" class="d-block w-50" alt="...">
                    </div>
                </div>
            </div>
                ...
                <div class="row warousel-row m-auto" class="warousel">
                    <div class="col d-flex flex-column justify-content-center align-items-center" class="wtext" style="width: 75%; ">
                        ...
                        <div class="wkontak">
                            ...
                            <p class="wlink"><img src="{{asset('assets/profil-desa/img/wisata/wcontact.png')}}" alt="" class="wimg">-</p>
                        </div>
                    </div>
                    <div class="col d-flex justify-content-center align-items-center">
    
                        <img class="wisata-img" src="../assets/profil-desa/img/wisata/gwk.png" class="d-block w-50" alt="...">
                    </div>
                </div>
            </div>
            <div class="carousel-item"class="warousel">
                ...
                <div class="row warousel-row m-auto" class="warousel">
                    <div class="col d-flex flex-column justify-content-center align-items-center" class="wtext">
                        ...
                        <div class="wkontak">
                            <a href="https://goo.gl/maps/nqJMTQPYEzrjcqx59" class="wlink"><img src="{{asset('assets/profil-desa/img/wisata/wloc.png')}}" alt="" class="wimg">Sumberbanteng Wetan, Segaran, Gedangan</a>
                            <p class="wlink"> <img src="{{asset('assets/profil-desa/img/wisata/wtime.png')}}" class="wimg"> Sudah ditutup</p>
                            <p class="wlink"><img src="{{asset('assets/profil-desa/img/wisata/wcontact.png')}}" alt="" class="wimg" >-</p>
                        </div>
                    </div>
                    <div class="col d-flex justify-content-center align-items-center">
                        <img class="wisata-img" src="../assets/profil-desa/img/wisata/kapur.png" class="d-block w-50" alt="...">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row " id="warousel-mobile">
                    ...
                    <div class="container col d-flex justify-content-center align-items-center" id="wtext">
                        ...
                        <div id="wkontak">
                            ...
                            <a href="https://wa.me/6283837908426" id="wlink"><img src="{{asset('assets/profil-desa/img/wisata/wcontact.png')}}" alt="" id="wimg" width>083837908426</a>
                        </div>
                    </div>
