<!-- Slideshow container -->
<div class="text-container" style="width: 35%;">
    <div class="wisata-detail" style="">
    ...
    <div class="wisata-detail" style="display: block;">
...
<div class="carousel-container" style="width: 45%;">

    <!-- Full-width images with number and caption text -->
    <div class="wisata-carousel fade" style="">
      <img src="{{ asset('assets/profil-desa/img/wisata/loo.png') }}">
      <div class="text">Kolam Renang Sumberloo</div>
    </div>
  
    <div class="wisata-carousel fade active" style="">
  ...
  {{-- <div class="prow">
    ...
    <div class="pcolumn" onclick="plusDivs(1)">
        <div class="pdpict">
            <img class="pdslide" src="{{ asset('assets/profil-desa/img/wisata/loo.png') }}" style="width:400px" onclick="plusDivs(1)">
            <img class="pdslide" src="{{ asset('assets/profil-desa/img/wisata/gwk.png') }}" style="width:400px" onclick="plusDivs(1)">
            <img class="pdslide" src="{{ asset('assets/profil-desa/img/wisata/kapur.png') }}" style="width:400px" onclick="plusDivs(1)">
        </div>
    </div>
</div> --}}
